  ...
  return (
    <div className="w-full grid grid-cols-9 gap-10 lgl:gap-0 px-6">
      ...
      <div className="col-span-9 md:col-span-4">
        <ResumeTitle title="Design & Development" icon={<SiArtstation />} />
        {/* web Design */}
        <div className="py-4">
          ...
          {/* Graffics Design */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Graphics Design</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <div className="py-4">
          ...
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Redux Tolkit</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        {/* English */}
        <ul className="py-4 flex flex-col gap-8 border-b-[1px] border-b-zinc-800">
